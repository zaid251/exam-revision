...
export default function App() {
  ...
  return (
    <div style={{ background: theme.bg, minHeight: "100vh", fontFamily: "'Source Serif 4', Georgia, serif" }}>
      ...
      {/* BACK BUTTON */}
      <div style={{ background: theme.surface, borderBottom: `1px solid ${theme.border}`, padding: "10px 32px" }}>
        <Link to="/" style={{ color: theme.q1, fontFamily: "'Syne', sans-serif", fontSize: 13, fontWeight: 600, textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 6, opacity: 0.85 }}
